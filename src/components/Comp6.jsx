...
const Comp6 = () => {
  ...
  return (
    <div className="mt-[150px]">
      ...
      <h1 className="text-[40px] sm:text-[45px] md:text-[50px] lg:text-[55px] xl:text-[60px] mb-[100px] text-[#2E2E2E] text-center w-[350px] sm:w-[500px] md:w-[600px] lg:w-[700px] xl:w-[900px] leading-[45px] sm:leading-[50px] md:leading-[55px] lg:leading-[60px] xl:leading-[65px] m-auto font-bold">
